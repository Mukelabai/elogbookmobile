...
{
   public class StaffNewAssignmentQuestionsViewModel : BaseViewModel
    {
        public const string ViewName = "StaffNewAssignmentQuestionsPage";




        public StaffNewAssignmentQuestionsViewModel()
        {
        ...
        public async Task LoadItemId(APIStaffSubmission item)
        {
            try
            {
                ...
                Questions = await DBService.GetSubmissionQuestions(SelectedSubmission.AssignmentId);
